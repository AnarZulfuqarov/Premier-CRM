...
export const api = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getAllProductsBySearchName: builder.query({
            query: (keyword = "") => ({
                url: `/Products/search`,
                params: {keyword},
            }),
        ...
        getMonthlyOrderStatusStatikNew: builder.query({
            query: ({productId,month,year, companyId}) => ({
                url: `/Orders/product/daily-stats?productId=${productId}&year=${year}&companyId=${companyId}&month=${month}`,
            }),
        }),
