...
const SupplierCategories = () => {
  ...
  const { data: getCategorieDeleteMyPending } =
    useGetCategorieDeleteMyPendingQuery();
  ...
  const { data: getCategorieUpdateMyPending } =
    useGetCategorieUpdateMyPendingQuery();
          ...
          <div className="table-wrapper">
            <div className="table-scroll">
              <table className="order-history-detail-supplier__table">
                ...
                <tbody>
                  {/* Əgər loading-dirsə, təkcə loading yazısını göstər */}
                  {isSearching ? (
                    <tr>
                      <td
                        colSpan="3"
            ...
            <button
              onClick={async () => {
                try {
                  ...
                  showPopup(
                    "Kateqoriya düzəliş tələbi göndərildi",
                    "Seçilmiş kateqoriya üzrə redaktə tələbiniz uğurla göndərildi və baxılmaq üçün sistemə daxil edildi.",
                    "success"
                  );
                } catch (error) {
                  showPopup(
              ...
              <button
                ...
                onClick={async () => {
                  try {
                    ...
                    refetch();
                    showPopup(
                      "Kateqoriyanın silinmə tələbi göndərildi",
                      "Seçilmiş kateqoriya üzrə silinmə tələbiniz uğurla göndərildi və baxılmaq üçün sistemə daxil edildi.",
                      "success"
                    );
                  } catch (error) {
                    showPopup(
