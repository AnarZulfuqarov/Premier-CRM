...
// yuxarı importların altında
    ...
    return (
        <div className="order-history-detail-accounter-main">
            <div className="order-history-detail-accounter">
                <h2>
                    <NavLink className="link" to="/accounter/history">— Tarixçə</NavLink>{' '}
                    — Sifariş detalları
                </h2>
  ...
  <path d="M11.9551 7.44141H11.9655" stroke="#ED0303" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <input
                        ...
                        min={todayISO}              // keçmiş günlər bloklanır
                        value={dueDate}
                        onChange={(e) => {
                            // təhlükəsizlik: istifadəçi min-dən kiçik dəyər yazsa, bu günə çək
