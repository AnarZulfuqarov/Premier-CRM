...
import {
  ...
  useGetAllVendorsBySearchNameQuery,
...
const SuperAdminVendors = () => {
  ...
  const filteredVendors = searchName
    ? getAllVendorsSearch?.data || []
    : vendors || [];
  ...
  return (
    <div className="super-admin-vendors-main">
                  ...
                  <tr key={order.id}>
                    ...
                    <td>
                      ...
                      >
                        ...
                        >
                          <path
                            d="M18.333 6.033a1 1 0 00-.042-.32 1 1 0 00-.199-.38L14.558 1.908a1 1 0 00-1.183-.182l-2.359 2.359-9.108 9.109a1 1 0 00-.275.553l-.001.029v3.533a1 1 0 001 1h3.533a1 1 0 00.554-.154l9.058-9.108 2.358-2.358a1 1 0 00.24-.756ZM5.692 16.667H3.333v-2.358l8.275-8.275 2.359 2.359-8.275 8.274ZM15.142 7.217l-2.359-2.359 1.184-1.175 2.358 2.358-1.183 1.176Z"
                            fill="#919191"
                          />
                        </svg>
                        {/* delete icon */}
                    ...
                    <td>
                      <button
                        onClick={() =>
                          navigate(`/superAdmin/vendor/${order.id}`)
                        }
                      >
                        Ətraflı
                      </button>
      ...
      {editModalVisible && (
        <div
          className="vendor-edit-modal-overlay"
        ...
        >
          ...
          >
            ...
            <p className="delete-message">
              Vendoru silmək istədiyinizə əminsiz?
            </p>
