      ...
      <div className="super-admin-bolme">
        <div className={"root"}>
          <h2>
            ...
            <NavLink
              className="link"
              to={`/superAdmin/companies/${department?.companyId}/sobe`}
            >
              — Şöbə
            </NavLink>
            — Bölmə
        ...
        <div className={"headerr"}>
          <div className={"head"}>
            <h2>Bölmə</h2>
            <p>
              Şöbəyə aid olan bölmə siyahısına baxın, dəyişikliklər edin və yeni
              bölmə yaradın.
            </p>
          </div>
          <button
            onClick={() =>
              navigate(`/superAdmin/companies/sobe/${id}/bolmeAdd`)
            }
          >
            <svg
                  ...
                  <tr key={section.id}>
                    ...
                    <td>
                      <button
                        onClick={() =>
                          navigate(
                            `/superAdmin/companies/bolme/persons/${section.id}`
                          )
                        }
                      >
                        Ətraflı
        ...
        <div className="modal-overlay" onClick={() => setDeleteSectionId(null)}>
          ...
          >
            ...
            <p className="delete-message">
              Bölməni silmək istədiyinizə əminsiz?
            </p>
