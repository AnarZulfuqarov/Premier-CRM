            ...
            <div className="super-admin-people-detail">
                <div className={"headerr"}>
                    <div className={"head"}>
                        ...
                        <p>Burada istifadəçilərin hansı sistem bölmələrinə giriş və səlahiyyətlərinin olduğunu görə bilərsiniz.</p>
                    </div>
                    <div>
                ...
                <div className="table-wrapper">
                  ...
                  <span style={{display: 'flex', gap: '10px', justifyContent: 'center'}}>
                    ...
                    <svg onClick={() => setDeleteIndex(i)} style={{ cursor: 'pointer' }} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
