...
import {
  ...
  useGetAllDepartmentsBySearchNameQuery,
  ...
  return (
    <div className="super-admin-sobe-main">
      <div className="super-admin-sobe">
        <div className={"root"}>
          <h2>
            <NavLink className="link" to="/superAdmin/companies">
              — Şirkətlər
            </NavLink>{" "}
            — Şöbə
          </h2>
        ...
        <div className={"headerr"}>
          <div className={"head"}>
            <h2>Şöbə</h2>
            <p>
              Şirkətə aid olan şöbə siyahısına baxın, dəyişikliklər edin və yeni
              şöbə yaradın.
            </p>
          </div>
          <button
            onClick={() => navigate(`/superAdmin/companies/${id}/sobeAdd`)}
          >
            <svg
                  ...
                  <tr key={dept.id}>
                    ...
                    <td>
                      <button
                        onClick={() =>
                          navigate(
                            `/superAdmin/companies/sobe/${dept.id}/bolme`
                          )
                        }
                      >
                        Ətraflı
        ...
        <div className="modal-overlay" onClick={() => setDeleteDeptId(null)}>
          ...
          >
            ...
            <p className="delete-message">
              Şöbəni silmək istədiyinizə əminsiz?
            </p>
