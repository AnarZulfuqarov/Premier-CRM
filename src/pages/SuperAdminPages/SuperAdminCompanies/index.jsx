...
import {
  ...
  useGetAllCompaniesBySearchNameQuery,
...
const SuperAdminCompanies = () => {
  ...
  } = useGetAllCompaniesBySearchNameQuery(searchName, {
    skip: !searchName,
  });
  ...
  // 🔹 Backend search-a əsaslanan seçim
  const activeCompanies = searchName ? searchedCompanies : data;

  // 🔹 UI üçün şirkət siyahısı formatı
  const companies = activeCompanies.map((item) => ({
    id: item.id,
    name: item.name,
      ...
      <div className="super-admin-companies">
        <div className="headerr">
          <div className="head">
            <h2>Şirkətlər</h2>
            <p>
              Şirkət siyahısına baxın, dəyişikliklər edin və yeni şirkət əlavə
              edin
            </p>
          </div>
                  ...
                  <tr key={company.id}>
                    ...
                    <td>
                      ...
                      >
                        ...
                        >
                          <path
                            d="M18.3337 6.03367C18.3343 5.924 18.3133 5.81528 18.2718 5.71375C18.2303 5.61222 18.1692 5.51987 18.092 5.44201L14.5587 1.90867C14.4808 1.83144 14.3885 1.77033 14.2869 1.72886C14.1854 1.68739 14.0767 1.66637 13.967 1.66701C13.8573 1.66637 13.7486 1.68739 13.6471 1.72886C13.5456 1.77033 13.4532 1.83144 13.3753 1.90867L11.017 4.26701L1.90867 13.3753C1.83144 13.4532 1.77033 13.5456 1.72886 13.6471C1.68739 13.7486 1.66637 13.8573 1.66701 13.967V17.5003C1.66701 17.7214 1.7548 17.9333 1.91108 18.0896C2.06736 18.2459 2.27933 18.3337 2.50034 18.3337H6.03367C6.15028 18.34 6.26692 18.3218 6.37602 18.2801C6.48513 18.2385 6.58427 18.1744 6.66701 18.092L15.7253 8.98367L18.092 6.66701C18.1679 6.58614 18.2299 6.49321 18.2753 6.39201C18.2834 6.32558 18.2834 6.25843 18.2753 6.19201C18.2792 6.15321 18.2792 6.11413 18.2753 6.07534L18.3337 6.03367ZM5.69201 16.667H3.33367V14.3087L11.6087 6.03367L13.967 8.39201L5.69201 16.667ZM15.142 7.21701L12.7837 4.85867L13.967 3.68367L16.317 6.03367L15.142 7.21701Z"
                            fill="#919191"
                          />
                        </svg>
                        <svg
                    ...
                    <td>
                      <button
                        onClick={() =>
                          navigate(`/superAdmin/companies/${company.id}/sobe`)
                        }
                      >
                        Ətraflı
                      </button>
        ...
        <div className="modal-overlay" onClick={() => setDeleteCompanyId(null)}>
          ...
          >
            <p className="delete-message">
              Şirkəti silmək istədiyinizə əminsiz?
            </p>
